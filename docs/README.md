...
See [INSTALLATION.md](INSTALLATION.md) for detailed setup instructions covering local development, Docker, and production deployments.
...
### With RAG and Web Search

```python
response = await client.post(
    "http://localhost:8000/api/v1/chat",
    json={
        "question": "What are the latest FastAPI security best practices?",
        "use_rag": True,
        "use_web": True,
        "rag_top_k": 5,
...
|----------|-------------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | System architecture, layers, data flow, design decisions |
| [SYSTEM_OVERVIEW.md](SYSTEM_OVERVIEW.md) | High-level system purpose, components, and interactions |
| [INSTALLATION.md](INSTALLATION.md) | Setup instructions for all environments |
| [QUICKSTART.md](QUICKSTART.md) | Get running in 5 minutes |
| [CONFIGURATION.md](CONFIGURATION.md) | All environment variables and settings |
| [API_REFERENCE.md](API_REFERENCE.md) | Complete API endpoint documentation |
| [AGENT_SYSTEM.md](AGENT_SYSTEM.md) | Multi-agent orchestration and reasoning |
| [MEMORY_SYSTEM.md](MEMORY_SYSTEM.md) | Vector memory, conversation store, authority model |
| [RAG_PIPELINE.md](RAG_PIPELINE.md) | Retrieval-augmented generation pipeline |
| [KNOWLEDGE_GRAPH.md](KNOWLEDGE_GRAPH.md) | Entity extraction, graph storage, trust scoring |
| [TOOL_ROUTER.md](TOOL_ROUTER.md) | Neural tool selection and tool registry |
| [PLUGIN_SYSTEM.md](PLUGIN_SYSTEM.md) | Plugin discovery, isolation, and execution |
| [VECTOR_DATABASE.md](VECTOR_DATABASE.md) | FAISS and Qdrant backends, migration |
| [PROMPT_EVOLUTION.md](PROMPT_EVOLUTION.md) | Automated prompt versioning and A/B testing |
| [SWARM_EXECUTION.md](SWARM_EXECUTION.md) | Parallel agent execution strategies |
| [RELIABILITY_LAYER.md](RELIABILITY_LAYER.md) | Circuit breakers, retries, timeouts, load guards |
| [SECURITY_MODEL.md](SECURITY_MODEL.md) | Authentication, injection defense, content safety |
| [OBSERVABILITY.md](OBSERVABILITY.md) | Metrics, tracing, logging, dashboards |
| [TESTING.md](TESTING.md) | Test structure, running tests, chaos testing |
| [DEPLOYMENT.md](DEPLOYMENT.md) | Docker, CI/CD, production deployment |
| [SCALING.md](SCALING.md) | Horizontal scaling strategies |
| [PERFORMANCE.md](PERFORMANCE.md) | Bottlenecks, caching, optimization |
| [ERROR_HANDLING.md](ERROR_HANDLING.md) | Exception hierarchy, failure modes, recovery |
| [CONTRIBUTING.md](CONTRIBUTING.md) | How to contribute to the project |
| [DEVELOPMENT_GUIDE.md](DEVELOPMENT_GUIDE.md) | Developer onboarding and extension guide |
| [DIRECTORY_STRUCTURE.md](DIRECTORY_STRUCTURE.md) | Complete repository layout explanation |
| [CODE_WALKTHROUGH.md](CODE_WALKTHROUGH.md) | Module-by-module code documentation |

---

## Contributing

We welcome contributions. Please read [CONTRIBUTING.md](CONTRIBUTING.md) for the workflow, coding standards, and testing requirements.
