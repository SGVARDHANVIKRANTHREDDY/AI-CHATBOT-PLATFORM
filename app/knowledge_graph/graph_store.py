...
class GraphStore:
    ...
    def _save(self):
        try:
            with open(self.path, "w", encoding="utf-8") as f:
                json.dump({"entities": list(self.entities), "relationships": self.relationships}, f, indent=2)
        except Exception as e:
    ...
    def get_trusted_relationships(self, min_trust: float = 0.5) -> list[dict[str, str]]:
        ...
        """
        return [r for r in self.relationships if r.get("trust_score", 1.0) >= min_trust]
