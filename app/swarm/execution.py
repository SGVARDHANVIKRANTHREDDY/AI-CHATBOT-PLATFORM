...
from app.reasoning_graph.models import ReasoningGraph
...
Remove redundancy and resolve any conflicts."""
        ...
        merged = await self.llm.ask(
            merge_prompt, system_prompt="You are a synthesis agent that merges multiple perspectives."
        )
        return merged
