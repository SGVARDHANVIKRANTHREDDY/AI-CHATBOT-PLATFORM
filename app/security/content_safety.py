...
class QuarantineStore:
    ...
    def add(self, doc: Dict[str, Any], verdict: SafetyVerdict) -> None:
        ...
        _LOG.warning(
            ...
            verdict.source, verdict.prompt_injection_score, verdict.reasons,
        )
    ...
    def release(self, index: int) -> Optional[Dict[str, Any]]:
...
class ContentSafetyFilter:
    ...
    **rejected** outright.  Documents from unknown domains with borderline
    ...
    def scan(self, doc: Dict[str, Any]) -> SafetyVerdict:
        ...
        if rejected:
            _LOG.warning("Document REJECTED: %s (injection=%.2f trust=%.2f quality=%.2f)",
                         source, injection, trust, quality)
