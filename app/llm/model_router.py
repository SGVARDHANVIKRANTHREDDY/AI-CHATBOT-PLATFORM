...
from app.shared.monitoring import LLM_TOKEN_USAGE
...
class ModelRouter:
    ...
    def __init__(self):
        ...
        self.routes = {
            "coding": re.compile(r"(?i)\b(code|python|js|javascript|java|rust|implement|function|class|refactor|debug|api)\b"),
    ...
    def get_model_for_intent(self, intent: str) -> str:
        ...
        # Default to general purpose HF model
