...
async def test_rag_reranking_logic():
    ...
    with patch("sentence_transformers.SentenceTransformer"), \
        ...
        with patch.object(retriever.reranker, 'rerank', return_value=[{"text": "best chunk", "score": 0.99}]) as mock_rerank:
            with patch("app.rag.retriever.settings.RERANKING_ENABLED", True):
